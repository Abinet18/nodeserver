...
const fetchData = () => {
    ...
    xhr.onload = () => {
        if (xhr.status == 200) {
            ...
            const span = tracer.startSpan('fetching data failure');
            span.end();
        }
    };
    xhr.send();
...
},{"@opentelemetry/api":32,"@opentelemetry/context-zone":65,"@opentelemetry/exporter-zipkin":102,"@opentelemetry/instrumentation":126,"@opentelemetry/instrumentation-document-load":111,"@opentelemetry/instrumentation-user-interaction":116,"@opentelemetry/instrumentation-xml-http-request":121,"@opentelemetry/sdk-trace-base":155,"@opentelemetry/sdk-trace-web":163}]},{},[173]);
